    ...
    try {
      ...
      if (profile.tipo === 'clinica') {
        ...
        const medicoCompleto: MedicoCompleto = {
          ...
          status: medicoData.ativo ? 'ativo' : 'inativo',
          tipo: medicoData.tipo,
          ativo: medicoData.ativo,
          plano_medico: medicoData.plano_medico,
      ...
      const medicosFormatados: MedicoCompleto[] = data?.map(item => {
        ...
        return {
          ...
          status: item.ativo && medico.ativo ? 'ativo' : 'inativo',
          tipo: medico.tipo,
          ativo: medico.ativo,
          plano_medico: medico.plano_medico,
